...
export const ContextStep = () => {
  const { setContextAnswer, nextStep, prevStep, priorityProblem } = useQuizStore();
  const { subtitle, por_problema } = quizData.entry1_behavior.context;
